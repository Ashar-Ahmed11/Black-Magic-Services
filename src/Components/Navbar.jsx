...
const Navbar = () => {
  return (
    <>
      <nav className="py-2 navbar  w-90 p-3 navbar-expand-lg sticky-top " style={{ height: window.innerWidth>768&&'80px', backgroundColor: '#f7f8f9' }}>
        <div className=" container-fluid d-flex justify-content-between " style={{ width: '80%' }}>
          ...
          <div className="collapse navbar-collapse" id="navbarNav" style={{ backgroundColor: 'white', borderRadius: '8px', padding: '1rem' }}>
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item mx-2">
                <Link className="nav-link fs-5 fw-bold" to="/">Success Story</Link>
              </li>
