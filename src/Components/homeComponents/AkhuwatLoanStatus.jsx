...
import asaanQarz22 from '../../Images/imageFive.jpg'
    ...
    <div className="container py-5" id='loan-status'>
      <div className="row align-items-center justify-content-center">
        ...
        <div className="col-md-6 p-5">
          <h2 className="fw-bold mb-3">Lorem ipsum dolor sit amet.</h2>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae rem ab quibusdam maiores. Maiores asperiores, totam qui nam veniam pariatur.
          </p>
        </div>
      </div>
